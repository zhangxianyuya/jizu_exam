...
#
# Generated by Vivado on Tue Nov 05 15:06:36 +0800 2019
...
# Script info
echo -e "dmem.sh - Script generated by export_simulation (Vivado v2017.1 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_11 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dmem xil_defaultlib.dmem xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim dmem -key {Behavioral:sim_1:Functional:dmem} -tclbatch cmd.tcl -log simulate.log
}
