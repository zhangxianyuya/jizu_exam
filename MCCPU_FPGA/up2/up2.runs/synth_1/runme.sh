...
HD_PWD='D:/FPGA/up/up2/up2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MCCPUSOC_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MCCPUSOC_Top.tcl
