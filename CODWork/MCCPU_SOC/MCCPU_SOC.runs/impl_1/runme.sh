...
HD_PWD='D:/CODWork/MCCPU_SOC/MCCPU_SOC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MCCPUSOC_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MCCPUSOC_Top.tcl -notrace
