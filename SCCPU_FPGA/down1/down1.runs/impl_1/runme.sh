...
HD_PWD='D:/FPGA/down/down1/down1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SCCPUSOC_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SCCPUSOC_Top.tcl -notrace
