...
main:   addi $2, $0, 5          # initialize $2 = 5     00      0       20020005
        ...
        nor  $4, $3, $2         # $4 = ~(3 or 5) = ~7     03      c       00e22025
        #jalr $5, $3
        and  $5, $3, $4         # $5 = (12 and 7) = 4   04      10      00642824
        andi $5, $7, 5         # $5 = 4 + 7 = 11       05      14      00a42820
        sll  $2, $2, 2
        jr   $3
        bne  $5, $7, label2     # shouldn't be taken    06      18      10a7000a
        slti $4, $3, 13         # $4 = (12 < 7) = 0     07      1c      0064202a
